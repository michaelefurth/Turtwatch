...
drop policy if exists "own_friendship_select" on friendship;
...
drop policy if exists "own_cheer_select" on cheer;
...
drop policy if exists "gg_member_select" on group_goal_member;
...
drop policy if exists "gg_select" on group_goal;
...
drop policy if exists "gift_select" on gift;
...
drop policy if exists "own_hatchling_select" on user_hatchling;
